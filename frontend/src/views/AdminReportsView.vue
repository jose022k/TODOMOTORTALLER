...
export default {
  ...
  computed: {
    ...
    visibleSections() {
      const icons = {
        ganancias: '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 10h12"/><path d="M4 14h9"/><path d="M19 6a7.7 7.7 0 0 0-5.2-2A7.9 7.9 0 0 0 6 12a7.9 7.9 0 0 0 7.8 8 7.7 7.7 0 0 0 5.2-2"/></svg>',
  ...
  methods: {
    ...
    async printReport() {
      ...
      // Set page title so "Save as PDF" suggests filename "ReporteTallerN#0000005.pdf"
